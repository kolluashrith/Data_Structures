...
classes are data structures because of the way they allow for the organization and manipulation of data stored.

## Part III: Algorithm Example
One algorithm in the game is the Game.runGameLoop function that continuously 
